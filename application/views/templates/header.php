...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicon -->
        <link rel = "shortcut icon" type = "image / x-icon" href = "<?php echo base_url('build/images/favicon/favicon-loopna-32x32.png'); ?>">
        <link rel = "shortcut icon" type = "image / x-icon" href = "<?php echo base_url('build/images/favicon/favicon-loopna-16x16.png'); ?>">
        ...
        <meta property="og:image" itemprop="image" content="<?php echo base_url('build/images/loopna-banner-profile.jpg'); ?>">
